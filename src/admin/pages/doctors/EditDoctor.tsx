...
const EditDoctor = () => {
  ...
  const fetchDoctor = async () => {
    try {
      const { data } = await axios.get(`https://listee-backend.onrender.com:5000/api/doctors/${id}`);
      if (data.success) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.patch(`https://listee-backend.onrender.com:5000/api/doctors/${id}`, payload);
