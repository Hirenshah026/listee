...
const AstrologerChatPage = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://listee-backend.onrender.com/api/messages/users/${ASTRO_ID}`)
  ...
  const openChat = async (u: ChatUser, index: number) => {
    ...
    const res = await axios.get(
      `https://listee-backend.onrender.com/api/messages/${ASTRO_ID}/${u._id}`
    );
  ...
  const sendMessage = async () => {
    ...
    const res = await axios.post("https://listee-backend.onrender.com/api/messages", {
      senderId: ASTRO_ID,
