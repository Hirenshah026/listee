...
const UserLiveList: React.FC = () => {
  ...
  return (
    // Background ko yahan halka gray kiya hai (bg-slate-50)
    <div className="flex justify-center bg-slate-200 h-[100dvh] w-full overflow-hidden font-sans">
      <div className="w-full max-w-[450px] bg-slate-50 flex flex-col h-full relative shadow-2xl">
        ...
        {/* --- Scrollable Content --- */}
        {/* BG Yahan bhi slate-50 hai cards ko highlight karne ke liye */}
        <main className="flex-1 overflow-y-auto bg-slate-50 px-4 pt-2 scrollbar-hide">
          {loading ? (
            ...
            <div className="grid grid-cols-2 gap-4 pb-24"> 
              {liveAstros.map((astro) => (
                <div 
                  ...
                  className="bg-white rounded-[28px] border border-white shadow-[0_8px_20px_rgba(0,0,0,0.04)] active:scale-95 transition-all cursor-pointer overflow-hidden"
                >
                  {/* Image Section */}
                  <div className="relative h-40">
                    ...
                    <div className="absolute bottom-3 left-3 right-3 text-white">
                        <h4 className="font-bold text-[13px] truncate leading-tight">
                            {astro.name}
                        </h4>
                  ...
                  {/* Join Button Section */}
                  <div className="p-2.5">
                    <button className="w-full bg-slate-900 text-white py-2 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-1 active:bg-black">
            ...
            <div className="flex flex-col items-center justify-center h-full text-center py-10">
               ...
               <p className="text-slate-400 text-[10px]">Experts will be online soon</p>
            </div>
          )}
        </main>
